  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-yellow-400/20 to-orange-500/20 border border-yellow-500/30 flex items-center justify-center">
        ...
        <Card className="border border-white/10 bg-card/50">
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="issueDate" type="date" {...register("issueDate")} className="border-white/15" />
              {errors.issueDate && <p className="text-sm text-destructive">{errors.issueDate.message}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="eventName">Event Name</Label>
              <Input id="eventName" placeholder="e.g. TECHKRITI 2026" {...register("eventName")} className="border-white/15" />
              {errors.eventName && <p className="text-sm text-destructive">{errors.eventName.message}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="eventLocation">Event Location</Label>
              <Input id="eventLocation" placeholder="e.g. IIT Kanpur" {...register("eventLocation")} className="border-white/15" />
            ...
            <div className="space-y-2">
              ...
              <Input id="eventDates" placeholder="e.g. 19–22 March 2026" {...register("eventDates")} className="border-white/15" />
              {errors.eventDates && <p className="text-sm text-destructive">{errors.eventDates.message}</p>}
            </div>
            <div className="space-y-2 md:col-span-2">
              <Label htmlFor="achievement">Achievement</Label>
              <Input id="achievement" placeholder="e.g. 1st Place — Robo-War 30kg" {...register("achievement")} className="border-white/15" />
